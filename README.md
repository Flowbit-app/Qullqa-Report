...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Supervisar F.V de productos</td>
      <td>Siempre</td>
      <td>Siempre</td>
      <td>Siempre</td>
    </tr>
...
#### Segmento 2: Farmacias Indepenientes 
<p align = "center"> </p>
<table>
  <thead>
    <tr>
      <th>Tasks</th>
      <th>Pedro Aguilar</th>
      <th>Angélica Rojas</th>
      <th>Maria Mariños</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Registrar medicamento por lote</td>
      <td>Siempre</td>
      <td>A veces</td>
      <td>Siempre</td>
    </tr>
    <tr>
      <td>Controlar ubicación de medicamentos</td>
      <td>Siempre</td>
      <td>Siempre</td>
      <td>A veces</td>
    </tr>
    <tr>
      <td>Identificar medicamentos más demandados</td>
      <td>Siempre</td>
      <td>Siempre</td>
      <td>Siempre</td>
    </tr>
    <tr>
      <td>Venta de medicamentos en efectivo</td>
      <td>Muchas veces</td>
      <td>A veces</td>
      <td>A veces</td>
    </tr>
    <tr>
      <td>Comprar productos en campañas de laboratorios</td>
      <td>Siempre</td>
      <td>A veces</td>
      <td>A veces</td>
    </tr>
    <tr>
      <td>Validar certificación médica</td>
      <td>Siempre</td>
      <td>Siempre</td>
      <td>Siempre</td>
    </tr>
...
Luego, de las actividades recopiladas del segundo segmento de farmacias independientes, se observa que identificar los medicamentos más demandantes es de las tareas más fundamentales para poder comparar ganancia/costo y poder pedir mayor stock a futuro. Luego, evidentemente el siguiente es el registro de un medicamento por lote debido al gran volúmen de stock que se puede ordenar. Finalmente, la certificación médica es de lo más relevante por su importancia en el sector salud.
